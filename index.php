...
<body>
                    ...
                    <?php foreach ($cart_items as $item): ?>
                        <div class="cart-item">
                            <div class="cart-item-info">
                                ...
                                <p>Quantity: <?= $item['quantity'] ?> × ₱<?= number_format($item['product']['price'], 2) ?></p>
                            </div>
    ...
    <footer>
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            <p style="font-size: 18px; margin-bottom: 10px;">&copy; <?= date('Y') ?> Amakha, The Smell Of Quality in a Bottle. All Rights Reserved.</p>
